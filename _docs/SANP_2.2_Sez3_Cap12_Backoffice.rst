...
|                 |                 | cumulativo.     |                 |
+-----------------+-----------------+-----------------+-----------------+
| 2.              | **Ricezione     | nel giorno D+1, | Esegue SCT di   |
|                 | SCT**           | la Banca        | cui al punto 1  |
|                 |                 | Cassiera/Tesori |                 |
|                 |                 | era             |                 |
|                 |                 | dell’EC riceve  |                 |
|                 |                 | dal PSP,        |                 |
...
|                 |                 | sola RT+        |                 |
+-----------------+-----------------+-----------------+-----------------+
| 3.              | **Quadratura    | nel giorno D+2  | Il PSP genera   |
|                 | FDR**           | il motore,      | il FDR,         |
...
3. .. rubric:: Gestione degli errori
   ...
   6. .. rubric:: Gestione degli errori di revoca
